...
StringDataFileDSMC = '/Users/abieler/data/Coma/DSMC/CG_1.3_au_03/CG_1.3_au_03.CO.dat'
isDust = 1
DustSizeMin = 0
DustSizeMax = 1e-7
...
cmd_string += "--DoShowPlots=y --StringPlotting=bokeh --StringUserTrajectoryFile=%s " % (StringUserTrajectoryFile)
