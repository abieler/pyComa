...
def cmdline_args(parser):
    ...
    parser.add_argument("--iInstrumentSelector", type=int, choices=[1, 2, 3, 4, 5, 6, 7, 8, 9], default=3)
    ...
    parser.add_argument("--QDust", type=float, default=1e5)      #dust production rate kg/second, used for an analytic model
