...
4b) execute "python setupXXX.py build_ext --inplace" in the shell inside
the pyComa directory. (XXX = OSX, LINUX. depending on operating system)
4c) on OSX mpi4py might be broken. to fix this create the following symlink:
